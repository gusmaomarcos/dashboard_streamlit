...
with st.sidebar.expander('Quantidade de parcelas'): #ok
...
with coluna2:
    st.download_button('Download dos dados', data=converte_csv(dados_filtrados), file_name=nome_arquivo, mime='text/csv',
